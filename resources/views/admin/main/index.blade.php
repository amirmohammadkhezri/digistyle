            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="box box-success">
                    ...
                    <div class="box-body chat" id="chat-box">
                        <!-- chat item -->
                        <div class="item">
                            <img src="/admin/dist/img/user4.jpg" alt="user image" class="online">

                            <p class="message">
                                <a href="#" class="name">
                                    <small class="text-muted pull-left"><i class="fa fa-clock-o"></i> 2:15</small>
امیر محمد خضری                                </a>
                                از خرید این محصول بسیار راضی هستم و ممنون برای این همه خدمات عالی
                            </p>
                        ...
                        <!-- chat item -->
                        <div class="item">
                            <img src="/admin/dist/img/user3.jpg" alt="user image" class="offline">
                            ...
                            <p class="message">
                                ...
                                یودیمی بهترین مجموعه آموزشی در زمینه برنامه نویسی میباشد.
                            </p>
                        </div>
                        <!-- /.item -->
                        <!-- chat item -->
                        <div class="item">
                            <img src="/admin/dist/img/user2.jpg" alt="user image" class="offline">
                            ...
                            <p class="message">
                                ...
                                برای آموزش لاراول باید به ویو جی اس مسلط باشیم؟ خیر نیازی نیست.
                            </p>
                        </div>
                        <!-- /.item -->
                    </div>
