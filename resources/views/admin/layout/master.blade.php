...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/admin/dist/img/user3.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/admin/dist/img/user4.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/admin/dist/img/user4.jpg" class="user-image" alt="User Image">
                            <span class="hidden-xs">امیر محمد خضری</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019 <a href="https://www.amir.khzri.ir">khezri Studio</a>.</strong> All rights
        reserved.
    </footer>
