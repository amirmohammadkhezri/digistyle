            ...
            <div id="content" class="col-sm-12">
                <div itemscope itemtype="http://schema.org/محصولات">
                    ...
                    <div class="row product-info">
                        <div class="col-sm-4">
                            <div class="image"><img class="img-responsive" style="text-align: center !important;" itemprop="image" id="zoom_01" src="{{$product->photos[0]->path}}" title="لپ تاپ ایلین ور" alt="لپ تاپ ایلین ور" data-zoom-image="{{$product->photos[0]->path}}" /> </div>
